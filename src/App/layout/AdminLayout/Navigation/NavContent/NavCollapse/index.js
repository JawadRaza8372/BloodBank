    ...
    render() {
        ...
        const subContent = (
            ...
            <Aux>
                ...
                <a style={{color:"white !important"}} href={DEMO.BLANK_LINK} className={navLinkClass.join(' ')} onClick={() => this.props.onCollapseToggle(this.props.collapse.id, this.props.type)}>
                    <NavIcon items={this.props.collapse} />
                    {itemTitle}
                    <NavBadge layout={this.props.layout} items={this.props.collapse} />
                </a>
                <ul style={{color:"white !important"}} className="pcoded-submenu">
                    {navItems}
                </ul>
            </Aux>
        );
        ...
        if (this.props.layout === 'horizontal') {
            mainContent = (
                <li style={{color:"white !important"}} className={navItemClass.join(' ')} onMouseLeave={() => this.props.onNavCollapseLeave(this.props.collapse.id, this.props.type)} onMouseEnter={() => this.props.onCollapseToggle(this.props.collapse.id, this.props.type)}>
                    {subContent}
                </li>
            );
        } else {
            mainContent = (
                <li style={{color:"white !important"}} className={navItemClass.join(' ')}>
                    {subContent}
                </li>
            );
        }
