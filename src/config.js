export default {
    defaultPath: '/home',
    basename: '/pro-blood', // only at build time to set, like /datta-able
    ...
    navActiveListColor: 'active', // active-default, (active-blue, active-red, active-purple, active-lightblue, active-dark are not available in lite version)
